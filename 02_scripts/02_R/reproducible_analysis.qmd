---
title: "Privacy vs. Profit: The Impact of Google MV3 on Ad Blocker Effectiveness"
subtitle: "Reproducible Analysis - Full Script"
author:
  - name: Karlo Lukic
...
This Quarto document contains the **complete** analysis script that reproduces all figures and tables from the paper "Privacy vs. Profit: The Impact of Google's Manifest Version 3 (MV3) Update on Ad Blocker Effectiveness" (PoPETs 2026).

**Paper:** [arXiv:2503.01000](https://arxiv.org/abs/2503.01000)

**Note:** This document runs from the `02_scripts/02_R/` directory. All file paths are relative to that location.
